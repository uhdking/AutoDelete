...
BOT_TOKEN    = os.environ.get("BOT_TOKEN", "6073642688:AAE7rmdOo15T3jOJ4leqliN8uREaYjosLlc")
...
CHATS        = [int(cht) for cht in os.environ.get("CHATS", "-1001655485024 -1001861187663").split()]
